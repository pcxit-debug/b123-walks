    ...
    <div className="flex min-h-screen items-center justify-center bg-background px-4">
      <div className="max-w-md text-center">
        ...
        <p className="mt-2 text-sm text-muted-foreground">
          That path doesn't exist. Let's get you back on the trail.
        </p>
        <div className="mt-6">
          <Link
            to="/"
...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "B123 Walks — Community Walking Group in the West Midlands" },
      {
        name: "description",
        content:
          "B123 Walks is a friendly community walking group organising regular social walks across the West Midlands. Walk. Talk. Connect.",
      },
      { name: "author", content: "B123 Walks" },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "theme-color", content: "#1b2c4a" },
    ],
    links: [
